...
for(int r=0;r<qntComponentes;r++){
    printf("%d menor:%d\n",componentesConexos[r].qnt,componentesConexos[r].menor);
}

printf("CIDADE JOAO: %d COMPONENTE: %d\n",cidadeJoao,componenteCidadeJoao);
printf("MAIOR COMPONENTE CONEXA: %d MENOR INDICE DA MAIOR COMP CONEXA: %d\n",maiorComponenteConexa,valorMenorIndiceComponenteConexa);
